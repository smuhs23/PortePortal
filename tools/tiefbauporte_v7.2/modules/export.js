...
import { downloadSchemas, openSchemaPreview, listSchemaTargets } from './schema.js';
          ...
          <div style="display:flex;flex-direction:column;gap:8px">
            ...
            <button class="export-btn" data-fmt="schema-svg" style="display:flex;gap:10px;padding:14px;background:#fafbfc;border:1px solid var(--line);border-radius:5px;cursor:pointer;text-align:left;font-size:13px">
              ...
              <div>
                ...
                <div style="font-size:11px;color:var(--ink-3);margin-top:2px">SVG-Datei pro Verteiler – in PowerPoint einfügen &amp; bearbeiten</div>
              </div>
            </button>
