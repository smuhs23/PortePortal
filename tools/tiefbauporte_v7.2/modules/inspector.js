...
function renderObjectInspector(ctx, el){
  ...
  el.innerHTML = `
    ...
    <button id="iAddSupply" style="width:100%;margin-top:6px;padding:8px;background:var(--green);color:#fff;border:none;border-radius:5px;font-weight:700;font-size:12px;cursor:pointer">+ Einspeisung hinzufügen…</button>
