...
const DEFAULT_CATALOG = [
  ...
  { id:'kvs', name:'KVS Kabelverteilerschrank', icon:'KVS', pos:'5E.', price:275.00, unit:'Stk', cat:'Verteilung', emoji:'📦', color:'#E65100', shape:'square', kw:false, amp:true, fav:true },
  { id:'mws', name:'MWS Messwandlerschrank', icon:'MWS', pos:'6E.', price:275.00, unit:'Stk', cat:'Verteilung', emoji:'📊', color:'#EF6C00', shape:'square', kw:false, amp:true },
  { id:'zas', name:'ZAS Zähleranschlusssäule', icon:'ZAS', pos:'7E.', price:275.00, unit:'Stk', cat:'Verteilung', emoji:'🔢', color:'#F57F17', shape:'square', kw:false, amp:true },
  { id:'nws', name:'NWS Netzwerkverteiler', icon:'NWS', pos:'', price:0, unit:'Stk', cat:'Verteilung', emoji:'🌐', color:'#827717', shape:'square' },
  { id:'trafo', name:'Trafostation kompakt', icon:'TRA', pos:'4aE.', price:10350.00, unit:'Stk', cat:'Netzanschluss', emoji:'🏭', color:'#D84315', shape:'square', kw:true },
  { id:'best', name:'Bestandsanschluss HAK', icon:'HAK', pos:'', price:0, unit:'Stk', cat:'Netzanschluss', emoji:'🔌', color:'#3E2723', shape:'square', kw:true, amp:true, fav:true },
...
function defaultState(){
  return {
    ...
    traces: [],
    selectedCat: null,
    viz: { pins:true, traces:true, labels:false },
