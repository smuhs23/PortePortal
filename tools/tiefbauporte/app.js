...
// ========== Map ==========
// v6.4: tapTolerance & tapHold für besseres Touch-Drag-Verhalten
const map = L.map('map', {
  zoomControl: false,
  tap: true,
  tapTolerance: 20,    // mehr Toleranz auf Touch (Default 15) — leichter zu treffen
  // touchZoom bleibt aktiv für Pinch-Zoom
}).setView([52.4512, 13.2890], 18);
