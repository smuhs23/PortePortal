...
// v6.3: Statistik pro Segment — Anzahl Kabel-Stück und Anzahl unterschiedlicher Typen
export function segmentCableStats(t, segIdx) {
  ...
  return { typen: types.size, stueck, cabsHere: cabs };
}
...
function renderTraceSegments(t, ctx) {
  ...
  t.segments.forEach((seg, i) => {
    ...
    d.onclick = (e) => {
      ...
      // Normaler Klick: Segment-Editor öffnen
      openSeg(t.id, i, ctx);
    };
    c.appendChild(d);
  });
